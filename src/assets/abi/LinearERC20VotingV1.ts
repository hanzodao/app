export const LinearERC20VotingV1Abi = [
  ...
  {
    anonymous: false,
    inputs: [{ indexed: true, internalType: 'address', name: 'azoriusModule', type: 'address' }],
    name: 'AzoriusSet',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: 'basisNumerator', type: 'uint256' }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint32', name: 'proposalId', type: 'uint32' },
      { indexed: false, internalType: 'uint32', name: 'votingEndBlock', type: 'uint32' },
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: 'quorumNumerator', type: 'uint256' }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'requiredProposerWeight', type: 'uint256' },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'azoriusModule', type: 'address' },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint32', name: 'votingPeriod', type: 'uint32' }],
  ...
  },
  {
    inputs: [],
    name: 'azoriusModule',
    outputs: [{ internalType: 'contract IAzoriusV1', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{ internalType: 'address', name: '_azoriusModule', type: 'address' }],
    name: 'setAzorius',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_basisNumerator', type: 'uint256' }],
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_quorumNumerator', type: 'uint256' }],
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_requiredProposerWeight', type: 'uint256' }],
